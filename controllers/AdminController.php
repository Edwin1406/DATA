...
// MICRO 
 ...
 public static function produccion_diariaMicro(Router $router)
    {
        session_start();
        if (!isset($_SESSION['email'])) {
            header('Location: /');
...
// PERIODICO 
 ...
 public static function produccion_diariaPeriodico(Router $router)
    {
        session_start();
        if (!isset($_SESSION['email'])) {
            header('Location: /');
        ...
        // unset($_POST['id']); // <- clave
            ...
            $produccion_diaria->unidad_x_dia = $_POST['unidad_x_dia'] ?? 0;
            $produccion_diaria->metros_lineales = $_POST['metros_lineales'] ?? 0;
            $produccion_diaria->id_corrugador = $_POST['id_periodico'] ?? null;
            $produccion_diaria->hora_inicio = $_POST['hora_inicio'] ?? null;
            $produccion_diaria->hora_fin = $_POST['hora_fin'] ?? null;
            $produccion_diaria->desperdicio_lamina = $_POST['desperdicio_lamina'] ?? 0;
            $produccion_diaria->kilos_x_dia = $_POST['kilos_x_dia'] ?? 0;
            ...
            if ($produccion_diaria->linea == 'PERIODICO') {
                $produccion_diaria->metros_lineales = $_POST['metros_lineales'] =  0 ?? null;
                $produccion_diaria->desperdicio_lamina = $_POST['desperdicio_lamina'] = 0 ?? null;
                $produccion_diaria->peso_un = $_POST['peso_un'] = 0 ?? null;
                $produccion_diaria->turno = $_POST['turno'] = null ?? null;
            ...
            if (empty($alertas)) {
                $produccion_diaria->guardar();
                header('Location: /admin/diaria/produccion_diariaPeriodico?id_periodico=' . $produccion_diaria->id_corrugador . '&exito=1');
            }
        } else {
            $alertas = [];
        }
        ...
        // debuguear($nombre);
        $router->render('admin/diaria/produccion_diariaPeriodico', [
            'titulo' => 'MEGASTOCK-DESARROLLO',
            'nombre' => $nombre,
            'email' => $email,
            'corrugador' => $corrugador,
...
// SEPARADORES 
 ...
 public static function produccion_diariaSeparadores(Router $router)
    {
        session_start();
        if (!isset($_SESSION['email'])) {
            header('Location: /');
        ...
        $id_separadores = $_GET['id_separadores'] ?? null;

        $corrugador = Ventas::where('id', $id_separadores);
        ...
        // unset($_POST['id']); // <- clave
            ...
            $produccion_diaria->unidad_x_dia = $_POST['unidad_x_dia'] ?? 0;
            $produccion_diaria->metros_lineales = $_POST['metros_lineales'] ?? 0;
            $produccion_diaria->id_corrugador = $_POST['id_separadores'] ?? null;
            $produccion_diaria->hora_inicio = $_POST['hora_inicio'] ?? null;
            $produccion_diaria->hora_fin = $_POST['hora_fin'] ?? null;
            $produccion_diaria->desperdicio_lamina = $_POST['desperdicio_lamina'] ?? 0;
            $produccion_diaria->kilos_x_dia = $_POST['kilos_x_dia'] ?? 0;
            ...
            if ($produccion_diaria->linea == 'SEPARADORES') {
                $produccion_diaria->metros_lineales = $_POST['metros_lineales'] =  0 ?? null;
                $produccion_diaria->desperdicio_lamina = $_POST['desperdicio_lamina'] = 0 ?? null;
                $produccion_diaria->peso_un = $_POST['peso_un'] = 0 ?? null;
                $produccion_diaria->turno = $_POST['turno'] = null ?? null;
            ...
            if (empty($alertas)) {
                $produccion_diaria->guardar();
                header('Location: /admin/diaria/produccion_diariaSeparadores?id_separadores=' . $produccion_diaria->id_corrugador . '&exito=1');
            }
        } else {
            $alertas = [];
        }
        ...
        // debuguear($nombre);
        $router->render('admin/diaria/produccion_diariaSeparadores', [
            'titulo' => 'MEGASTOCK-DESARROLLO',
            'nombre' => $nombre,
            'email' => $email,
            'corrugador' => $corrugador,
            'id_separadores' => $id_separadores,
            'turnoCorrugador1' => $turnoCorrugador1,
        ]);
    }
