     ...
     <div class="sidebar-wrapper active">
         ...
         <div class="sidebar-menu">
             <ul class="menu">
                 ...
                 <?php } ?>
                 <!-- pruebas-->
                 <?php if ($userEmail === 'pruebas@megaecuador.com' || $userEmail === 'produccion@megaecuador.com' || $userEmail === 'mantenimiento@megaecuador.com' || $userEmail === 'corrugador@megaecuador.com' || $userEmail === 'flexo@megaecuador.com') { ?>
                     <li class="sidebar-item  has-sub">
                         <a href="#" class='sidebar-link'>
                     ...
                     <div class="card-body">
                         <div class="form-group">
                             ...
                             <button type="button" class="btn btn-outline-success" data-bs-toggle="modal"
                                 ...
                                 Agregar desperdicio corrugador
                             </button>
