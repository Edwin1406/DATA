        ...
        function cargarContenido(url, agregarAlHistorial = true) {
            fetch(url)
                ...
                .then(html => {
                    ...
                    if (newContent) {
                        const nuevoHTML = newContent.innerHTML.trim();
                        const actualHTML = contentContainer.innerHTML.trim();

                        // Solo reemplazar si el contenido es diferente
                        if (nuevoHTML !== actualHTML) {
                            contentContainer.innerHTML = nuevoHTML;
                            ...
                            console.log('El contenido ya está cargado. No se hace ningún cambio.');
                        }
                    } else {
