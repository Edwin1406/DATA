         ...
         <div class="card">
             <ul class="nav nav-tabs">
                 ...
                 <?php if ($email !== 'ventas@megaecuador.com') { ?>
                     <li class="nav-item">
                         <a class="nav-link active" href="/admin/pruebas/crearPeriodico">Registro Periodico</a>
                     </li>
                 <?php } ?>
             </ul>
         </div>
                             ...
                             <tr>
                                 ...
                                 <td>
                                     ...
                                     <div class="d-flex gap-1">
                                         ...
                                         <a href="/admin/diaria/produccion_diariaPeriodico?id_periodico=<?= $periodicos->id ?>" class="btn btn-primary btn-sm">Diaria</a>
