            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">REGISTRO DOBLADO</h4>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="/admin/pruebas/registrarVenDoblado" method="POST">
                    <!-- Fila 1 -->
                    <div class="row g-3">
...
<div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="detalleCorrugadorForm" action="/admin/pruebas/registroDetalleDoblado" method="POST">
