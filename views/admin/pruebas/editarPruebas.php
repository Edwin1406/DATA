            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="POST" action="/admin/pruebas/crearPruebas?id=<?php echo $venta->id; ?>" enctype="multipart/form-data" onsubmit="return bloquearBoton(this)">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="cantidad" class="form-control"
                                                ...
                                                value="<?php echo $consumo->cantidad; ?>"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="observaciones" class="form-control"
                                                ...
                                                value="<?php echo $consumo->observaciones; ?>"
                                                >
                                        </div>
                                    </div>
