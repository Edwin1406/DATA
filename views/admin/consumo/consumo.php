...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var selectElement = document.getElementById('personalSelect');

        // Mantener el orden de selección sin reorganizar
        selectElement.addEventListener('change', function() {
            var selectedOptions = Array.from(selectElement.selectedOptions);
            var selectedValues = selectedOptions.map(option => option.value);

            // Establecer nuevamente el valor del select para mantener el orden
