                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="/admin/diaria/editarproduccion_diariaPeriodico?id=<?= $produccionDiaria->id ?>" class="btn btn-primary btn-sm">Editar</a>
                                        <form action="/admin/eliminarDiariaPeriodico" method="POST">
