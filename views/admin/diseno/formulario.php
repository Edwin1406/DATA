  ...
  <div class="col-md-6 col-12">
      <div class="form-group">
          ...
          <input type="text" id="proveedor" class="form-control"
              ...
              value="<?php echo ($diseno->proveedor); ?>">
      </div>
  </div>
  ...
  <div class="col-md-6 col-12">
      <div class="form-group">
          ...
          <input type="text" id="nombre_producto" class="form-control"
              ...
              value="<?php echo ($diseno->nombre_producto); ?>">
      </div>
  </div>
  ...
  <div class="col-md-6 col-12">
      <div class="form-group">
          ...
          <input type="text" id="codigo_producto" class="form-control"
              ...
              value="<?php echo ($diseno->codigo_producto); ?>">
      </div>
  </div>
  ...
  <div class="col-md-6 col-12">
      <div class="form-group">
          ...
          <select class="form-select" name="estado" id="estado">
              <option value="ENVIADO" <?php echo ($diseno->estado) === 'ENVIADO' ? 'selected' : ''; ?>>Enviado</option>
              <option value="PAUSADO" <?php echo ($diseno->estado) === 'PAUSADO' ? 'selected' : ''; ?>>Pausado</option>
              <option value="TERMINADO" <?php echo ($diseno->estado) === 'TERMINADO' ? 'selected' : ''; ?>>Terminado</option>
          </select>
      </div>
  </div>
